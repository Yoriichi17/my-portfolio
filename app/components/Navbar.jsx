...
const Navbar = () => {
  ...
  return (
    <nav className='fixed mx-auto border border-[#33353F] top-0 right-0 left-0 z-10 bg-[#121212] bg-opacity-100'>
      <div className='flex container lg:py-4  flex-wrap items-center justify-between mx-auto px-5 pt-1'>
        ...
        <div className='mobile-menu block md:hidden'>
            {
                ...
                ) : ( <button onClick={() => setNavBarOpen(false)} className='flex items-center px-3 py-3 border rounded border-slate-200 text-slate-200 hover:text-white hover:border-white'><Bars3Icon className='h-5 w-5'/></button> )
            }
        </div>
